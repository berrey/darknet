...
#lib = CDLL("/home/donghui/darknet/libdarknet.so", RTLD_GLOBAL)
    ...
    if showImage:
        try:
            ...
            for detection in detections:
                ...
                rr2, cc2 = draw.polygon_perimeter([x[1] + 0.5 for x in boundingBox], [x[0] for x in boundingBox], shape= shape)
                rr3, cc3 = draw.polygon_perimeter([x[1] - 0.5 for x in boundingBox], [x[0] for x in boundingBox], shape= shape)
                rr4, cc4 = draw.polygon_perimeter([x[1] for x in boundingBox], [x[0] + 0.5 for x in boundingBox], shape= shape)
                rr5, cc5 = draw.polygon_perimeter([x[1] for x in boundingBox], [x[0] - 0.5 for x in boundingBox], shape= shape)
